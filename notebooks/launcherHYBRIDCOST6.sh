...
echo "papermill 01_Zone_Control.ipynb ${case}_ALPHA_${alpha}_SCNAD${distance}K${kp}.ipynb \
-p PATH_SYMUVIA ${PATH_SYMUVIA} \
-p EXPERIMENT manhattan_A_V2_3_${distance}_5X5_${case}_${kp}_${td}_${alpha}_X_X_X_TEST \
-p CTR_ALG ${case} \
-p SELFISH ${alpha} \
-p KP ${kp} \
-p CO_KP ${kp} \
...
IT=$((IT+1))
papermill 01_Zone_Control.ipynb ${case}_ALPHA_${alpha}_SCNAD${distance}K${kp}.ipynb \
-p PATH_SYMUVIA ${PATH_SYMUVIA} \
-p EXPERIMENT manhattan_A_V2_3_${distance}_5X5_${case}_${kp}_${td}_${alpha}_X_X_X_TEST \
-p CTR_ALG ${case} \
-p SELFISH ${alpha} \
